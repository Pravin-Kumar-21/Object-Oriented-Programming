...
int main(){
   ...
   // s1.totalStudents=20;
    ...
    Student s2;
    cout<<s2.totalStudents<<endl;                             // so it is showing the value 20 now lets see the wwhat the value of object s1 is containing
    cout<<s1.totalStudents<<endl;                             // so it is showing the value 20
